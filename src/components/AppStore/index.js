...
class AppStore extends Component {
  ...
  getFilteredApps = searchedResults => {
    ...
    const categoryWiseApps = searchedResults.filter(
      eachApp => eachApp.category === activeTabId,
    )
    return categoryWiseApps
  }

  onSearchFilterResults = () => {
  ...
  render() {
    const searchedResults = this.onSearchFilterResults()
        ...
        <div className="app-container">
          ...
          <div className="search-container">
            <input
              ...
              onChange={this.changeAppsOnSearch}
            />
            <img
              src={SEARCH_ICON_URL}
              alt="search icon"
          ...
          <ul className="tab-container">
            {tabsList.map(eachTab => (
              <TabItem
                key={eachTab.tabId}
                tabDetails={eachTab}
                updateTab={this.activateTab}
                isActiveTab={activeTabId === eachTab.tabId}
              />
            ))}
          </ul>
          <ul className="all-app-container">
